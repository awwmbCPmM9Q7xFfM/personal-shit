...
#everything below will be updated later -------------------------------------------------
...
<html>
    ...
    <body>
        ...
        <nav>
            <ul>
                <li><a href="http://moe.stuy.edu/~rhossain30/finalProject/v10/home.html">Home</a></li>
                <li><a href="http://moe.stuy.edu/~rhossain30/finalProject/v10/country.html">All Countries</a></li>
            </ul>
        </nav>
        <p>Click on a country to see its graphs.</p>
        <ul>
            _NAV_
        </ul>
    </body>
...
'''
    ...
    z = ''
    while y < len(name):
        z += '<li><a href="http://moe.stuy.edu/~rhossain30/finalProject/v10/HTMLWeb/' + name[y] + '.html">' + name[y] + '</a></li>\n\t'
        y += 1
...
def htmlweb():
    y = 0
    h = '<img src="http://moe.stuy.edu/~rhossain30/finalProject/v10/Graphs/'
    while y < len(name):
        ok = '''
<!DOCTYPE HTML>
<html>
